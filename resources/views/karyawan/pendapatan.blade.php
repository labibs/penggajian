          ...
          <div class="panel">
            ...
            <div class="panel-body">
              <table class="table ">
                <thead>
                  <tr><td colspan="6">
                 <h4><center><b>DATA PENDAPATAN</b></center></h4>
               </td>
               <td >
                 ...
                 <tr>
                   ...
                   <td><center><a href="/karyawan/{{$karyawan->id}}/d_pendapatan">{{$karyawan->nik}}</a></center></td>
                   ...
                   <td><center>{{formatRupiah($karyawan->tot_pendapatan())}}</center></td>
                 </tr>
                  @endforeach
                   </tbody>
                 </table>
